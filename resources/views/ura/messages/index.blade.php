            ...
            <div class="table w-100">
                <div class="thead w-100">
                    <div class="table-row w-100 d-flex">
                        ...
                        <div class="table-cell col-6 col-md-3 col-5">Email</div>
                        <div class="table-cell col-6 col-md-3 col-4">Apartment</div>
                        <div class="table-cell col-md-2 col-3 text-md-start text-end col-1 d-none d-md-block">Date</div>
                    ...
                    @foreach ($messages as $message)
                        <a href="{{ route('ura.messages.show', $message->id) }}">
                            <div class="table-row w-100 d-flex {{ $loop->odd ? 'bg-lightgrey' : '' }}">
                                ...
                                <div class="table-cell col-6 col-md-3 col-5">{{ $message->mail }}</div>
                                <div class="table-cell col-6 col-md-3 col-4">{{ $message->apartment->title }}</div>
                                <div class="table-cell col-md-2 col-3 text-md-start text-end d-none d-md-block">
                                    {{ $message->created_at }}
                                </div>
                                <div class="table-cell col-1 d-none d-md-block px-4"><i class="fa-solid fa-eye fs-4"></i>
                                </div>
                            </div>
                        </a>
                    @endforeach
