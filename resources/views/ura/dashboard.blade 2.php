...
<div class="container-dashboard w-100">
    ...
    {{-- Logged message --}}
    <div id="logged-message" class="row mb-5 text-white">
        ...
        <div class="col-12 col-md-4 mb-3">
            <div class="card p-3 h-100">
                <div class="card-title px-3">
                    ...
                    <br>
                    <span>You currently have {{Auth::user()->apartment()->count()}} @if (Auth::user()->apartment()->count() == 1) apartment @else apartments @endif </span>
