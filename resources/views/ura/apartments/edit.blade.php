        ...
        <form action="{{ route('ura.apartments.update', $apartment->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror"
                    placeholder="Type here the title" value="{{ $apartment->title }}" maxlength="150">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="address" id="address" class="form-control @error('address') is-invalid @enderror"
                    placeholder="Address Here" value="{{ $apartment->address }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="number_of_rooms" id="number_of_rooms"
                    ...
                    placeholder="Type here the number of rooms" value="{{ $apartment->number_of_rooms }}" min="1"
                    max="120">
                <small id="number_of_roomsHelper" class="text-muted">Update the number of rooms, max: 120 | min:
                    1</small>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="number_of_beds" id="number_of_beds"
                    ...
                    is-invalid @enderror"
                    placeholder="Type here the number of beds" value="{{ $apartment->number_of_beds }}" min="1"
                    max="120">
                <small id="number_of_bedsHelper" class="text-muted">Update the number of beds, max: 120 | min: 1</small>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="number_of_baths" id="number_of_baths"
                    ...
                    placeholder="Type here the number of baths" value="{{ $apartment->number_of_baths }}" min="1"
                    max="120">
                <small id="number_of_bathsHelper" class="text-muted">Update the number of baths, max: 120 | min:
                    1</small>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="square_metres" id="square_metres"
                    ...
                    is-invalid @enderror"
                    placeholder="Type here the number of square metres" value="{{ $apartment->square_metres }}">
                <small id="square_metresHelper" class="text-muted">Update the number of square metres, max: 65535 | min:
                    1</small>
                @error('square_metres')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
