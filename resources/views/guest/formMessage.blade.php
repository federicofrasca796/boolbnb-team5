    ...
    <div class="container_message m-auto d-flex">
        <div class="col-12 col-md-6 px-2 h-100 d-flex align-items-center flex-column justify-content-center">
            <div class="w-100 mb-4">
                <a id="btn-back" href="{{ asset('/apartments/' . $apartment->slug) }}"><i
                        class="fa-solid fa-arrow-left-long fa-lg fa-fw"></i></a>
            </div>
                ...
                <div class="card-body p-5">
                    ...
                    <form action="{{ route('message.send') }}" method="POST">
                        ...
                        <div class="mb-3 d-none">
                            ...
                            @endif
                            <input type="text" name="apartment_id" id="apartment_id" class="form-control" placeholder=""
                                value="{{ $apartment->id }}">
                        </div>
                        <div class="mb-3 d-flex flex-column align-items-start justify-content-center">
                            ...
                            @guest
                                <input required type="text" name="name" id="name"
                                    class="form-control @error('name') is-invalid @enderror" placeholder="Type your name">
                            @elseif (Auth::check())
                                <input required type="text" name="name" id="name"
                                    class="form-control @error('name') is-invalid @enderror" placeholder="Type your name"
                        ...
                        <div class="mb-3 d-flex flex-column align-items-start justify-content-center">
                            ...
                            <textarea required class="form-control @error('body') is-invalid @enderror" name="body"
                                id="body" rows="3" minlength="30"></textarea>
