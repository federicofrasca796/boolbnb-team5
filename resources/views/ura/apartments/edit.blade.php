    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-8">
                ...
                <form action="{{ route('ura.apartments.update', $apartment->slug) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror"
                            placeholder="Type title here" value="{{ $apartment->title }}" maxlength="150" required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class=" col-3">
                            ...
                            <input type="text" name="latitude" id="latitude"
                                class="form-control @error('latitude') is-invalid @enderror" value="{{ $apartment->latitude }}"
                                required readonly>
                            @error('latitude')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="square_metres" id="square_metres"
                            ...
                            placeholder="Type floor area in square meters" value="{{ $apartment->square_metres }}" required
                            min="1" max="65535">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('number_of_beds') is-invalid @enderror" name="number_of_beds"
                            ...
                            @for ($i = 1; $i < 10; $i++)
                                <option value="{{ $i }}" {{ $apartment->number_of_beds == $i ? 'selected' : '' }}>
                                    {{ $i }}
                                </option>
                            @endfor
